...
- [制作を通して学んだこと・つまずいた点](#制作を通して学んだこと・つまずいた点)
- [構成](#構成)
- [使用方法](#使用方法)
- [特徴](#特徴)
...
各処理をサブルーチン化し、処理を分割することで保守性・再利用性が向上することを実感
「セル色に応じてスキップ」「グループ化」「入力制限」など、実務で必要なロジックを組み込むのに苦戦
統合シートの整形ルールを標準化するのが難しく、何度も実行→調整を繰り返した
すべてのマクロを連携させて1つのフローにまとめられたとき、達成感と実用性の両方を感じた
